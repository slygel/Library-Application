...
{
    Task<PaginatedList<BorrowingResponse>> GetAllBorrowingRequestsAsync(int pageIndex, int pageSize);
    Task<Result<PaginatedList<BorrowingResponse>>> GetUserBorrowingRequestsAsync(Guid userId, int pageIndex, int pageSize);
